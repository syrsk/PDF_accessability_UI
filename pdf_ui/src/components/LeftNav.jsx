      ...
      <Box sx={{ padding: isCollapsed ? 1 : 3, position: 'relative' }}>
        ...
        {(!isCollapsed || isMobile) && (
          ...
          <CardContent>
            ...
            <Divider sx={{ marginBottom: 2 }} />
            <Typography variant="body2" gutterBottom>
              Contact ITS Digital Accessibility Services at <a href="mailto:accessibleIT@syr.edu">accessibleIT@syr.edu</a> or drop in to <a href='https://itsaccessibility.syr.edu/help/' target="_blank">Digital Accessibility Office Hours</a>
            </Typography>
          </CardContent>
        </Card>
        )}
